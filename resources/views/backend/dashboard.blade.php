					...
					<div class="portlet light ">
						...
						<div class="portlet-body">
							<div id="site_statistics_loading">
								<img src="{{asset('public/')}}/theme/assets/admin/layout/img/loading.gif" alt="loading"/>
							</div>
									...
									<div class="scroller" style="height: 290px;" data-always-visible="1" data-rail-visible1="1">
										<div class="row">
											<div class="col-md-6 user-info">
												<img alt="" src="{{asset('public/')}}/theme/assets/admin/layout/img/avatar.png" class="img-responsive"/>
												<div class="details">
													<div>
														<a href="javascript:;">
														Robert Nilson </a>
					...
					<div class="portlet light ">
						...
						<div class="portlet-body" id="chats">
							<div class="scroller" style="height: 341px;" data-always-visible="1" data-rail-visible1="1">
								<ul class="chats">
									<li class="in">
										<img class="avatar" alt="" src="{{asset('public/')}}/theme/assets/admin/layout/img/avatar1.jpg"/>
										<div class="message">
											<span class="arrow">
											</span>
									...
									<li class="out">
										<img class="avatar" alt="" src="{{asset('public/')}}/theme/assets/admin/layout/img/avatar2.jpg"/>
										<div class="message">
											<span class="arrow">
											</span>
											<a href="javascript:;" class="name">
									...
									<li class="out">
										<img class="avatar" alt="" src="{{asset('public/')}}/theme/assets/admin/layout/img/avatar3.jpg"/>
										<div class="message">
											<span class="arrow">
											</span>
											<a href="javascript:;" class="name">
						...
						<div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
							...
							<ul class="media-list list-items">
								<li class="media">
									...
									<img class="media-object" src="{{asset('public/')}}/theme/assets/admin/layout/img/avatar3.jpg" alt="...">
								...
								<li class="media">
									<img class="media-object" src="{{asset('public/')}}/theme/assets/admin/layout/img/avatar1.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="{{asset('public/')}}/theme/assets/admin/layout/img/avatar4.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									<img class="media-object" src="{{asset('public/')}}/theme/assets/admin/layout/img/avatar2.jpg" alt="...">
									<div class="media-body">
							...
							<ul class="media-list list-items">
								<li class="media">
									...
									<img class="media-object" src="{{asset('public/')}}/theme/assets/admin/layout/img/avatar6.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="{{asset('public/')}}/theme/assets/admin/layout/img/avatar7.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									<img class="media-object" src="{{asset('public/')}}/theme/assets/admin/layout/img/avatar8.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="{{asset('public/')}}/theme/assets/admin/layout/img/avatar9.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									<img class="media-object" src="{{asset('public/')}}/theme/assets/admin/layout/img/avatar10.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="{{asset('public/')}}/theme/assets/admin/layout/img/avatar11.jpg" alt="...">
									<div class="media-body">
