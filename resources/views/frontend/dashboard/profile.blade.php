    ...
    <section class="theme-form-section">
       	<div class="col-md-12">
          	<div class="form-group">
				<label for="f_name" class="col-sm-3 control-label">First Name <span class="mandatory">*</span><span class="colon">:</span>
				</label>
				<div class="col-sm-6">
       ...
       <div class="col-md-12">
          <div class="form-group">
				...
				<div class="col-sm-6">
					{{Form::text( 'mobile',$data["user"]->mobile,array('class' => 'form-control', 'data-bvalidator'=>"number,minlength[10]",'placeholder'=>'Enter Mobile Number','maxlength'=>10) )}}
